...
<div class="col-md-3">
	<p>Loan Amount :</p>
	  ...
	  <div class="col-md-3">
      <input class="form-control" id="noOfDays" type="text" placeholder='Enter Tenure' 
   ...
   <div class="row">
    <div class="col-md-3">
	  ...
	  <div class="input-group">
	   <span class="input-group-addon"><i class="fa fa-rupee-sign"></i></span>
      <input class="form-control" id="dailyPayment" type="text"  placeholder='Enter EMI Amount' >
       </div>	
	  </div>
	  <div class="col-md-3">
      <p>Total Amount :</p>
...
<!-- 	  <div class="input-group">
	   <span class="input-group-addon"><i class="fa fa-rupee-sign"></i></span>  -->
      <input class="form-control" id="totalAmount" type="text" placeholder="Total Amount">
      </div>
   ...
   <div class="col-md-5">
	...
	<div class="col-md-4">
	 ...
	 <button  type="button" class="btn btn-danger"  id='close' onclick="window.location.href='https://ebiztradewebapp.azurewebsites.net/dashBoard'">Close Record</button>
   </div>
  </div>
  </div>
 <!---closing table  -->
...
/* $( function() {
 ...
 //-------------------------------------------------Get all loan type------------------------------------------------------------
  ...
  if((LoanIdObj!=null && LoanIdObj!=0))
	  {
			 $.ajax({
				    url: 'https://ebiztradewebapp.azurewebsites.net/get-loan-details-for-view-loan',
...
/* if((LoanIdObj!=null || LoanIdObj!=0) &&  )
	 ...
	 //  var balanceAmount=$('#balanceAmount').val();
	  ...
	  /*  if(loanTypeId ==0 || loanTypeId ==null || loanTypeId =="")
	   ...
	   if(validation==0){
		  ...
		  $.ajax({
			    url: 'https://ebiztradewebapp.azurewebsites.net/create-new-loan',
 ...
 //----------------------------------------search loan data by number name etc---------------------------  
   function searchBarrowerData(){
	   ...
	   if(searchDataVal==null || searchDataVal =="" )
		 ...
		 //  $("#alertMsg").append("Please enter details then click on search button. ");
		   ...
		   $.ajax({
			    url: 'https://ebiztradewebapp.azurewebsites.net/get-barrower-loan-user-list',
  ...
  /*  var radioData=$('input[name="selectUser"]:checked').val();
   ...
   $("#userTable").on('click','.radioUser',function(){
       ...
       $.ajax({
		    url: 'https://ebiztradewebapp.azurewebsites.net/get-barrower-loan-user-data',
 ...
 $("#loanAmount").on('keyup', function() {
	 ...
	 $('#loanAmount').change(function() {
		...
		loanAmnt=convertToFloat($('#loanAmount').val());
		calculateTotalAmount();
	 });
